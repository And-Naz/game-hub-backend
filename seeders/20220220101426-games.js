...
module.exports = {
	async up(queryInterface, Sequelize) {
		...
		await queryInterface.bulkInsert('games', [
			...
			{
				src: process.env.API_URL + '/api/static/games/La-casa-memory/index.html',
				name: 'La Casa Memory!',
				description: "La Casa Memory by Hasmik",
				rating: 70,
				author: 'Vardan-Petrosyan',
				price: 0,
				isDiscounted: 0,
				percentOfDiscount: 0,
				imageSrc: process.env.API_URL + '/api/static/images/lacasememory.jpg',
				createdAt: currentDate,
				updatedAt: currentDate,
			},
			{
				src: process.env.API_URL + '/api/static/games/Tic_Tac_Toe/index.html',
				name: 'Tic Tac Toe',
				description: "Pulitzer Prize award-winning historian James M. McPherson has written for young readers a stirring account of the greatest conflict to happen on our nation's soil, the Civil War, bringing to life the tragic struggle that divided not only a nation, but also friends and family. From the initial Confederate attack on Fort Sumter, to the devastating loss of life at Shiloh as Ulysses S. Grant led the Union to unexpected victory, to the brilliance of Stonewall Jackson's campaign at Shenandoah, to General Pickett's famous charge at Gettysburg, to the Union's triumph at Appo-mattox Court House, Fields of Fury details the war that helped shape us as a nation.Also included are personal anecdotes from the soldiers at the battlefront and the civilians at home, as well as profiles of historical luminaries such as Robert E. Lee, Abraham Lincoln, Jefferson Davis, and Ulysses S. Grant. McPherson also explores the varied roles that women played during the war, healthcare on the battlefield, and the demise of slavery.McPherson's narrative is highlighted with black-and-white photographs taken by Civil War photographers Mathew Brady and Timothy O'Sullivan, period oil paintings, and key campaign and battlefield maps, that make Fields of Fury the consummate book on the American Civil War for kids. (less)",
				rating: 70,
				author: "Tic Tac Toe by Hasmik",
				price: 0,
				isDiscounted: 0,
				percentOfDiscount: 0,
				imageSrc: process.env.API_URL + '/api/static/images/tiktaktoe.jpg',
				createdAt: currentDate,
				updatedAt: currentDate,
			},
			{
				src: process.env.API_URL + '/api/static/games/Hangman/index.html',
				name: 'Hangman',
				description: "Pulitzer Prize award-winning historian James M. McPherson has written for young readers a stirring account of the greatest conflict to happen on our nation's soil, the Civil War, bringing to life the tragic struggle that divided not only a nation, but also friends and family. From the initial Confederate attack on Fort Sumter, to the devastating loss of life at Shiloh as Ulysses S. Grant led the Union to unexpected victory, to the brilliance of Stonewall Jackson's campaign at Shenandoah, to General Pickett's famous charge at Gettysburg, to the Union's triumph at Appo-mattox Court House, Fields of Fury details the war that helped shape us as a nation.Also included are personal anecdotes from the soldiers at the battlefront and the civilians at home, as well as profiles of historical luminaries such as Robert E. Lee, Abraham Lincoln, Jefferson Davis, and Ulysses S. Grant. McPherson also explores the varied roles that women played during the war, healthcare on the battlefield, and the demise of slavery.McPherson's narrative is highlighted with black-and-white photographs taken by Civil War photographers Mathew Brady and Timothy O'Sullivan, period oil paintings, and key campaign and battlefield maps, that make Fields of Fury the consummate book on the American Civil War for kids. (less)",
				rating: 70,
				author: "Hangman by Hasmik",
				price: 0,
				isDiscounted: 0,
				percentOfDiscount: 0,
				imageSrc: process.env.API_URL + '/api/static/images/hangman.jpg',
				createdAt: currentDate,
				updatedAt: currentDate,
			},
			{
				src: process.env.API_URL + '/api/static/games/Mortal_Combat_Rock_Paper_Scissors/index.html',
				name: 'Mortal Combat Rock Paper Scissors',
				description: "Pulitzer Prize award-winning historian James M. McPherson has written for young readers a stirring account of the greatest conflict to happen on our nation's soil, the Civil War, bringing to life the tragic struggle that divided not only a nation, but also friends and family. From the initial Confederate attack on Fort Sumter, to the devastating loss of life at Shiloh as Ulysses S. Grant led the Union to unexpected victory, to the brilliance of Stonewall Jackson's campaign at Shenandoah, to General Pickett's famous charge at Gettysburg, to the Union's triumph at Appo-mattox Court House, Fields of Fury details the war that helped shape us as a nation.Also included are personal anecdotes from the soldiers at the battlefront and the civilians at home, as well as profiles of historical luminaries such as Robert E. Lee, Abraham Lincoln, Jefferson Davis, and Ulysses S. Grant. McPherson also explores the varied roles that women played during the war, healthcare on the battlefield, and the demise of slavery.McPherson's narrative is highlighted with black-and-white photographs taken by Civil War photographers Mathew Brady and Timothy O'Sullivan, period oil paintings, and key campaign and battlefield maps, that make Fields of Fury the consummate book on the American Civil War for kids. (less)",
				rating: 70,
				author: "Mortal Combat by Vardan",
				price: 0,
				isDiscounted: 0,
				percentOfDiscount: 0,
				imageSrc: process.env.API_URL + '/api/static/images/mortalcombat.jpg',
				createdAt: currentDate,
				updatedAt: currentDate,
			},
			{
				src: process.env.API_URL + '/api/static/games/BomberMan/index.html',
				name: 'BomberMan',
				description: "BomberMan by Ando",
				rating: 70,
				author: 'Andranik-Nazaryan',
				price: 0,
				isDiscounted: 0,
				percentOfDiscount: 0,
				imageSrc: process.env.API_URL + '/api/static/images/BombermanCapture.PNG',
				createdAt: currentDate,
				updatedAt: currentDate,
			},
			{
				src: process.env.API_URL + '/api/static/games/MemoryGame/index.html',
				name: 'MemoryGame',
				description: "MemoryGame by Ando",
				rating: 70,
				author: 'Andranik-Nazaryan',
				price: 0,
				isDiscounted: 0,
				percentOfDiscount: 0,
				imageSrc: process.env.API_URL + '/api/static/images/MemoryGameCapture.PNG',
				createdAt: currentDate,
				updatedAt: currentDate,
			}
		], {});
